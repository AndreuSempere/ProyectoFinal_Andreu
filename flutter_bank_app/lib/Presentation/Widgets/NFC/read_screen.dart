...
class _ReadScreenState extends State<ReadScreen> {
  ...
  String maskCardNumber(String cardNumber) {
    if (cardNumber.length > 4) {
      ...
      return cardNumber; // No enmascarar si el número es muy corto
    }
  }
  ...
  Widget build(BuildContext context) {
    ...
    switch (flowIndex) {
          ...
          child: Column(
            ...
            children: [
              ...
              Padding(
                ...
                child: Text(
                  "SDK ready. Use the button below to start scanning a card",
      ...
      case 2:
        ...
        break;
      case 3:
        String cardNumber = extractCardNumber(scanResult);
