...
describe('AccountsService', () => {
  ...
  describe('getAccount', () => {
    it('should return an account when xml is not provided', async () => {
      ...
      expect(MockAccountsRepository.findOneBy).toHaveBeenCalledWith({
        id_cuenta: 1,
      });
  ...
  describe('updateAccount', () => {
    ...
    it('should throw an exception when account is not found', async () => {
      ...
      await expect(
        accountsService.updateAccount(999, updateAccountDto),
  ...
  describe('deleteAccount', () => {
    ...
    it('should throw an exception when account is not found', async () => {
      ...
      await expect(accountsService.deleteAccount(999)).rejects.toThrow(
        HttpException,
      );
    });
  });
