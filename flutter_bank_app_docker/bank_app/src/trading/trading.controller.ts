...
export class TradingController {
  ...
  @ApiResponse({
    status: 200,
    description: 'Successfully retrieved all trading records.',
  })
  ...
  @ApiResponse({
    status: 201,
    description: 'Successfully created trading record.',
  })
